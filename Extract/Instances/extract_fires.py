...
gdf = gpd.read_file("FEUX_PROV.gpkg") # Path to the shapefile 
gdf = gdf.to_crs(4326)

plots,titles = get_full_plot(gdf, "Feux", "white") # The second parameter, "type" is changed depending on the Unique class's name we are extracting
